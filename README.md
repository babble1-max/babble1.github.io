...
<div class="overlay" id="write-ov" onclick="if(event.target===this)closeWrite()">
  <div class="write-panel">
    ...
    <div class="token-note">
      初回のみ：<a href="https://github.com/settings/tokens/new" target="_blank">GitHubのトークンページ</a>でトークンを発行して下さい。<br>
      スコープは <strong>repo</strong> にチェックを入れて生成、下の欄に貼り付けてください。
    </div>

    <div class="fg">
      <label class="fl">GitHub Token（初回のみ・保存されます）</label>
...
<script>
// ============================================================
// 設定：ここを自分のGitHubユーザー名とリポジトリ名に変更してください
// ============================================================
const GH_USER = 'あなたのGitHubユーザー名';
const GH_REPO = 'あなたのユーザー名.github.io';
...
async function publish() {
  ...
  try {
    ...
    const body2 = { message: `add post: ${title}`, content };
